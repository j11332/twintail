...
src_configure() {
	...
	local emesonargs=(
		...
		# -Degl_device=true # This should be dependent on wayland,video_drivers_nvidia, once eglstream support is there
		# -Dwayland_eglstream=true # requires packages egl-wayland for wayland-eglstream-protocols.pc
